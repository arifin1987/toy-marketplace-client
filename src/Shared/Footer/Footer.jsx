        ...
        <footer className="footer footer-center p-10 bg-primary text-primary-content">
            <div>
                ...
                <p className="font-bold">
                    ...
                    <h1 className="text-xl" >Car Planet Toys Industries Ltd <br />Providing reliable tech since 1992</h1>
                    
                </p>
                
                <p className="text-xl">Address: 12,Gulshan-2,Dhaka</p>
                <p className="text-xl">Phone: 12345678</p>
                <p className="text-xl">Email:carplanet@gmail.com</p>
